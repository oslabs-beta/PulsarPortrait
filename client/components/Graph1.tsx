...
export default function Graph1() {
  const [ url, setUrl ] = useState<string>("http://localhost:2222/d/c2ef0e4a-da28-4797-bd86-5c1957aa9039/newmessagesin?orgId=1&refresh=5s&viewPanel=1&viewPanel=1&kiosk")
